...
function (_React$Component) {
  ...
  function TableBox(props) {
    ...
    _this.onTableResize = function () {
      var tr = _this.tbody.querySelector('tr');

      var trWidth = tr && tr.clientWidth;
      var _this$tbody = _this.tbody,
          offsetWidth = _this$tbody.offsetWidth,
          clientHeight = _this$tbody.clientHeight,
          scrollHeight = _this$tbody.scrollHeight;
    ...
    _this.columns = [{
      ...
      render: function render(value, node) {
        ...
        return React.createElement("span", {
          ...
          onClick: function onClick(e) {
            e.stopPropagation(); // onCheck(node, !value);
          }
  ...
  _createClass(TableBox, [{
    ...
    value: function componentDidMount() {
      ...
      var tableWrap = document.querySelector('.department-table'); // addResizeListener(this.tbody, this.onTableResize);

      var offsetWidth = tableWrap.offsetWidth,
          offsetHeight = tableWrap.offsetHeight;
    ...
    value: function componentWillUnmount() {// removeResizeListener(this.tbody, this.onTableResize)
    }
  }, {
    key: "render",
